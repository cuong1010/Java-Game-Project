 ...
 * @author PC
 */
public class GameTimKhoBau extends javax.swing.JFrame {
   ...
   GameDTO game=new GameDTO();
    ...
    String MATK;
    HuongdanGameTKB hd=new HuongdanGameTKB();
    NoidungGameTKB nd=new NoidungGameTKB();
    public GameTimKhoBau(String MATK) {
     try {
   ...
   // <editor-fold defaultstate="collapsed" desc="showhide">  
    ...
    public void mouseEvent(MouseEvent evt)
    {
        ...
        for(int j=0;j<10;j++)
        {   
            if(khobau.end) DisableButton();
            else
            {   if(evt.getButton()==1 && evt.getSource()==b[i][j]) 
                {khobau.chuottrai(i, j);}
                else if(evt.getButton()==3 && evt.getSource()==b[i][j]) 
                khobau.chuotphai(i, j);
                lbDiem.setText(String.valueOf(khobau.getDiem()));
                lbRuong.setText(String.valueOf(khobau.getRuong()));
            }
        }
    }
    ...
    private void initComponents() {
        ...
        lbRuong = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setLocation(new java.awt.Point(347, 101));
        setPreferredSize(new Dimension(425+242,540));
        setResizable(false);
        ...
        jLabel2.setText("Số rương");

        lbRuong.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        lbRuong.setForeground(new java.awt.Color(179, 29, 36));
                        ...
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addComponent(lbRuong, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lbRuong, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameTimKhoBau("0000000000").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lbRuong;
